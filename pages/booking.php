        ...
        <div class="table-main table-responsive">
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-4 col-sm-12">
                            ...
                            <hr>
                            <p class="font-italic">*Note : Tunjukkan Bukti booking ini di Sekre Kotak Pena/COD dan lakukan proses pembayaran saat proses pengambilan sebelum melewati tanggal yang telah di tentukan dan diwajibkan membawa foto copy KTP.</p>
