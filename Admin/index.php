...
<head>
	...
	<title>Login Page . Kotak Pena</title>
...
<!-- <style>
  body {
	background-image: url("/Projek1/images/kotakpena.jpg");
}
</style>
<body> -->
		...
		<div class="login">
			<div class="login__content mt-3">
				<div class="login__head">
					<a href="index.html"><img src="dist/img/KOPEN.png" alt="Image" style="width:100px;height:150px;"></a>
					<p class="mt-3"><marquee>Komunitas Mahasiswa Jurnalistik Pecinta Karya </marquee></p>
				</div>
