	...
	<main class="main main--ml-sidebar-width">
		...
		<div class="container">
			<h1 class="display-4">Selamat Datang</h1>
				<p class="lead"><color="red">UKM Kotak Pena adalah salah satu unit kegiatan Mahasiswa yang ada di politeknik negeri indramayu yang mencakup Jurnalistik Dan Pers,Di jurnalistik kami Mengenalkan Tentang Pembuatan berita seperti angel kamera,Editing image editing video. Sedangkan di Pers kami memperkenalkan Terjun ke lapangan untuk meliput suatu berita/isu isu kampus atau luar kampus"</p>
					</div>
				</div>
  ...
  background-color: black;
			...
			<div class="mb-3 col-md-6 col-lg-4">
				<section class="info-box info-box--blue">
					...
					<a title="Detail Products" class="info-box__btn-detail" href="http://localhost/projek1/admin/adminweb.php?module=produk"><span class="fa fa-arrow-right"></span></a>
				</section>
			</div>
			<div class="mb-3 col-md-6 col-lg-4">
				<section class="info-box info-box--green">
					...
					<a title="Detail Members" class="info-box__btn-detail" href="http://localhost/projek1/admin/adminweb.php?module=member"><span class="fa fa-arrow-right"></span></a>
				</section>
			</div>
			<!-- <div class="mb-3 col-md-6 col-lg-4">
