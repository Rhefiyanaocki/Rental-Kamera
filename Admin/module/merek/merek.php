<?php 
	...
	if(isset($_POST['cari'])){
		$cari = $_POST['keyword'];
		$kueri_Kategori= mysqli_query($koneksi, "select * from merek where nama like '%$cari%'");
		var_dump($kueri_Kategori); 
		die;
	}else{
...
<head>
    ...
    <meta name="author" content="@RhefiyanaOcki">
	...
	<main class="main main--ml-sidebar-width">
		...
		<div class="col-12 mb-4">
				<section class="main__box">
					...
					<div class="card-body mb-3 col-3">
