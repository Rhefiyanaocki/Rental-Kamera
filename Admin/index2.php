...
<body>		
	...
	<main class="main main--ml-sidebar-width">
		<div class="row">
			...
			<div class="mb-3 col-lg-4">
				<section class="chart">
					<div class="chart__header">
						<h6>Browser Usage, January 2021</h6>
					</div>
					<div class="chart__body">
	...
	<footer class="footer footer--ml-sidebar-width">
		<p class="mb-2 mb-sm-0">Copyright &copy; Your Website 2021. All rights reserved</p>
		<p>Version 1.0.2</p>
	</footer>
