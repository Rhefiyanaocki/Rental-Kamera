...
<style>
  body {
	background-image: url("/Projek1/images/gedung.jpg");
}
</style>
<body>
<body class="form-v8">
	<div class="page-content">
		<div class="form-v8-content">
			<div class="form-left">
				<img src="images/KOPEN.png.png" width="250px">
			</div>
			<div class="form-right">
			<h1><center><marquee><font face="Courier New">Welcome To Website Penyewaan Kamera UKM Kotak Pena Polindra</font></marquee><span class="label label-default"></span></center></h1>
				<div class="tab">
				
					<div class="tab-inner">
						<button class="tablinks" onclick="openCity(event, 'sign-up')" id="defaultOpen"><font face="Courier New">Login</font></button>
					</div>
					<div class="tab-inner">
						<button class="tablinks" onclick="openCity(event, 'sign-in')"><font face="Courier New">Daftar</font></button>
					</div>
				</div>
					...
					<div class="tabcontent" id="sign-up">
						<div class="form-row">
							<label class="form-row-inner">
								<input type="text" name="username" id="full_name" class="input-text" required="required" autocomplete="new-username">
						...
						<div class="form-row">
							<label class="form-row-inner">
								<input type="password" name="password" id="password" class="input-text" required="required"  autocomplete="new-password">
